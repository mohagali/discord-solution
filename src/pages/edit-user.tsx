...
import { handleupdateUser} from '../api/user'
...
export default () => {
    ...
    const user=useSelector((state: RootState) => state.user.value.find(e=>e.id==Number(id)))
  ...
  const onSubmit: SubmitHandler<Inputs> = async (data) => {
    ...
    handleupdateUser(dispatch,Number(id),name,username,email);
    navigate("/")
      ...
      <div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div>
              ...
              <input defaultValue={user?.name} {...register("name", { required: true })}
            ...
            <div>
              ...
              <input defaultValue={user?.username} {...register("username", { required: true })}
          ...
          <Link to={"/"} 
            ...
            <button type="submit"
              className="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Update</button>
